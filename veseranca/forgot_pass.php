...
if(isset($_POST['forgot_pass'])){
    ...
    if($count_c == 0){
        ...
        try {
            ...
            $mail->SMTPAuth   = true;                             
            $mail->Username   = 'sergio.elicot@bisu.edu.ph';                 
            $mail->Password   = 'xldb qohz rnzm pejl';                        
            $mail->SMTPSecure = 'tls';                              
            $mail->Port       = 587;  
        
            $mail->setFrom('sergio.elicot@bisu.edu.ph', 'Your Name');       
            ...
            $mail->Body    = "
                ...
                <h3 align='center'> Your Password is: <span> <b>$c_pass</b> </span> </h3>
                <h3 align='center'> <a href='localhost/veseranca/checkout.php'>Click Here To Login Your Account</a> </h3>
            ";
